...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary *data = [serachDataArray objectAtIndex:indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIView *tempBg = [LooperToolClass createViewAndRect:CGPointMake(66*DEF_Adaptation_Font_x*0.5,10*DEF_Adaptation_Font*0.5) andTag:100 andSize:CGSizeMake(88*DEF_Adaptation_Font_x*0.5, 88*DEF_Adaptation_Font*0.5) andIsRadius:true andImageName:[[serachDataArray objectAtIndex:indexPath.row] objectForKey:@"news_img"]];

    [cell.contentView addSubview:tempBg];

    UILabel *titleNum = [LooperToolClass createLableView:CGPointMake(154*DEF_Adaptation_Font_x*0.5, 35*DEF_Adaptation_Font_x*0.5) andSize:CGSizeMake(334*DEF_Adaptation_Font_x*0.5, 38*DEF_Adaptation_Font_x*0.5) andText:[[serachDataArray objectAtIndex:indexPath.row] objectForKey:@"news_title"] andFontSize:13 andColor:[UIColor colorWithRed:217/255.0 green:217/255.0 blue:217/255.0 alpha:1.0] andType:NSTextAlignmentLeft];
...
-(void)initView{
    ...
    serachDataArray = [[NSMutableArray alloc] initWithCapacity:50];
