...
- (void)SG_setupSessionPreset:(NSString *)sessionPreset metadataObjectTypes:(NSArray *)metadataObjectTypes currentController:(UIView *)currentView {
    ...
    _videoPreviewLayer.frame = currentView.layer.bounds;
    [currentView.layer insertSublayer:_videoPreviewLayer atIndex:0];
