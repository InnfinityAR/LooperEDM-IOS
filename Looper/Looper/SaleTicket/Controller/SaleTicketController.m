...
-(instancetype)initWithDataDic:(NSDictionary *)dataDic orderDic:(NSDictionary*)orderDic andPrice:(NSInteger)price{
    if (self=[super init]) {
        [self.saleTicketVM getDataFromHTTP:dataDic  orderDic:orderDic andPrice:price];
