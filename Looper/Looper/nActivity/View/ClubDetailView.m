...
-(void)createScrollDataView{
    ...
    UILabel *djName =[[UILabel alloc] initWithFrame:CGRectMake(DEF_SCREEN_WIDTH*2+33*DEF_Adaptation_Font*0.5, 30*DEF_Adaptation_Font*0.5, 583*DEF_Adaptation_Font*0.5, 40*DEF_Adaptation_Font*0.5)];
    ...
    UILabel *djDetail =[[UILabel alloc] initWithFrame:CGRectMake(DEF_SCREEN_WIDTH*2+33*DEF_Adaptation_Font*0.5, 100*DEF_Adaptation_Font*0.5, 583*DEF_Adaptation_Font*0.5, 450*DEF_Adaptation_Font*0.5)];
    ...
    for (int i=0;i<[[_clubData objectForKey:@"information"] count] ;i++){
        ...
        [imageV sd_setImageWithURL:[[NSURL alloc] initWithString: [[[_clubData objectForKey:@"information"] objectAtIndex:i] objectForKey:@"photo"]] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
            
        }];
        imageV.tag = [[[[_clubData objectForKey:@"information"] objectAtIndex:i] objectForKey:@"activityid"] intValue];
    ...
    for (int i=0;i<[[[_clubData objectForKey:@"data"] objectForKey:@"avatar"] count] ;i++){
        ...
        UIImageView *imageV = [[UIImageView alloc] initWithFrame:CGRectMake(DEF_SCREEN_WIDTH+num_x,0+(num_y*288*DEF_Adaptation_Font*0.5), 268*DEF_Adaptation_Font*0.5, 268*DEF_Adaptation_Font*0.5)];
