...
-(void)createScrollView{
    ...
    scrollV.contentSize = CGSizeMake(DEF_SCREEN_WIDTH,[[_BrandData objectForKey:@"information"] count]*410*DEF_Adaptation_Font*0.5+490*DEF_Adaptation_Font*0.5);
...
-(void)createHorizontalScroll{
    ...
    HorizontalScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0,490*DEF_Adaptation_Font*0.5, DEF_SCREEN_WIDTH, [[_BrandData objectForKey:@"information"] count]*410*DEF_Adaptation_Font*0.5)];
    ...
    HorizontalScroll.contentSize = CGSizeMake(DEF_SCREEN_WIDTH*2, [[_BrandData objectForKey:@"information"] count]*410*DEF_Adaptation_Font*0.5);
...
-(void)createActiveCellView:(NSDictionary*)data andBgView:(UIView*)view{
    ...
    UILabel *locationLable = [[UILabel alloc] initWithFrame:CGRectMake(310*DEF_Adaptation_Font*0.5, 242*DEF_Adaptation_Font*0.5, 294*DEF_Adaptation_Font*0.5, 55*DEF_Adaptation_Font*0.5)];
    ...
    CGRect dateFrame = CGRectMake(310*DEF_Adaptation_Font*0.5, 235*DEF_Adaptation_Font*0.5, 294*DEF_Adaptation_Font*0.5, dateStringSize.height);
    locationLable.frame = dateFrame;
    
    if([data[@"ticketurl"] isEqualToString:@""]==true){
        
        UIImageView *icon_price=[LooperToolClass createImageView:@"icon_price.png" andRect:CGPointMake(278, 318) andTag:100 andSize:CGSizeMake(69*DEF_Adaptation_Font_x*0.5, 32*DEF_Adaptation_Font*0.5) andIsRadius:false];
        [view addSubview:icon_price];
    }else{
        UIImageView *icon_ticket=[LooperToolClass createImageView:@"icon_ticket.png" andRect:CGPointMake(278, 318) andTag:100 andSize:CGSizeMake(69*DEF_Adaptation_Font_x*0.5, 32*DEF_Adaptation_Font*0.5) andIsRadius:false];
        [view addSubview:icon_ticket];
    }
    
    UILabel *priceLable = [[UILabel alloc] initWithFrame:CGRectMake(368*DEF_Adaptation_Font*0.5, 318*DEF_Adaptation_Font*0.5, 235*DEF_Adaptation_Font*0.5, 32*DEF_Adaptation_Font*0.5)];
...
-(void)createScrollDataView{
    ...
    for (int i=0;i<[[_BrandData objectForKey:@"information"] count] ;i++){
        ...
        bgView.tag = [[[[_BrandData objectForKey:@"information"] objectAtIndex:i] objectForKey:@"activityid"] intValue];
        bgView.userInteractionEnabled=YES;
        UITapGestureRecognizer *singleTap =[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(createActiveView:)];
        [bgView addGestureRecognizer:singleTap];
        
        
        [self createActiveCellView:[[_BrandData objectForKey:@"information"] objectAtIndex:i] andBgView:bgView];
