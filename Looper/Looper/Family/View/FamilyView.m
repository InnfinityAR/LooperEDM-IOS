...
-(void)initView{
    ...
    contentView = [[UIView alloc] initWithFrame:CGRectMake(29*DEF_Adaptation_Font*0.5, 117*DEF_Adaptation_Font*0.5,582*DEF_Adaptation_Font*0.5, 976*DEF_Adaptation_Font*0.5)];
    [contentView setBackgroundColor:[UIColor colorWithRed:86/255.0 green:79/255.0 blue:109/255.0 alpha:1.0]];
