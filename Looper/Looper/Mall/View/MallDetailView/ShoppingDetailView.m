...
-(void)creatIntergralBtn:(UIView *)superV{
    ...
    UILabel *LB2=[[UILabel alloc]initWithFrame:CGRectMake(10*DEF_Adaptation_Font*0.5, 34*DEF_Adaptation_Font*0.5, 165*DEF_Adaptation_Font*0.5, 34*DEF_Adaptation_Font*0.5)];
    LB2.text=@"积分不足";
