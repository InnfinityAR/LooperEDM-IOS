...
- (void)awakeFromNib {
    ...
    self.cityLB=[[UILabel alloc]initWithFrame:CGRectMake(-12,  18*DEF_Adaptation_Font*0.5, 180*DEF_Adaptation_Font*0.5, 30*DEF_Adaptation_Font*0.5)];
    self.cityLB.shadowColor = [UIColor grayColor];
    //阴影偏移  x，y为正表示向右下偏移
    self.cityLB.shadowOffset = CGSizeMake(0.5, 0.5);
    ...
    self.cityLB.layer.cornerRadius=15*DEF_Adaptation_Font*0.5;
    ...
    self.cityLB.textAlignment=NSTextAlignmentCenter;
     self.shadowIV=[[UIImageView alloc]initWithFrame:CGRectMake(0,  18*DEF_Adaptation_Font*0.5, 100, 35*DEF_Adaptation_Font*0.5)];
