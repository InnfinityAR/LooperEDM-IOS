...
//        MainViewController *start = [MainViewController alloc];
    //测试语句
    ActivityViewController *start=[ActivityViewController new];
        ...
        [self.window makeKeyAndVisible];
#warning-用于读取storyBoard的controller
//        UINavigationController *navi=[[UIStoryboard storyboardWithName:@"Main" bundle:nil]instantiateViewControllerWithIdentifier:@"navi"];
