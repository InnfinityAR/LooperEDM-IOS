...
- (void)initHeader {
    ...
    _indicatorV=[LooperToolClass LoadingImageName:@"loading" andCount:53 andDuration:1.4 andloadScroll:true andPoint:CGPointMake(DEF_SCREEN_WIDTH/2-80,-10)];
   // _indicatorV.frame = CGRectMake((scrollViewW-labelw)/2,0, arrowW, arrowH);
    [_headerView addSubview:_indicatorV];
